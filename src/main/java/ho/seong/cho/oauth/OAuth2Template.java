...
public interface OAuth2Template {
   ...
   */
  OAuth2ProviderToken authorize(@NotNull final String code);
   ...
   */
  boolean isAuthorized(@NotNull final String oAuthId);
   ...
   */
  OAuth2UserInfo fetchUserInfo(@NotNull final String oAuthId);
   ...
   */
  void disconnect(@NotNull final String oAuthId);
}
